...
craftingTable.removeRecipe(<item:buzzierbees:blue_orchid_candle>);
craftingTable.removeRecipe(<item:buzzierbees:dandelion_candle>);
craftingTable.removeRecipe(<item:buzzierbees:oxeye_daisy_candle>);


//Add Blue Orchid Candle
craftingTable.addShaped("blue_orchid_candle_balance", <item:buzzierbees:blue_orchid_candle>,
...
craftingTable.addShaped("dandelion_candle_balance", <item:buzzierbees:dandelion_candle>,
		[[<item:buzzierbees:candle>, <item:minecraft:blaze_powder>], 
		[<item:minecraft:dandelion>, <item:minecraft:nether_star>]], null);


//Add Oxeye Daisy Candle	
craftingTable.addShaped("oxeye_daisy_balance", <item:buzzierbees:oxeye_daisy_candle>,
		[[<item:buzzierbees:candle>, <item:minecraft:blaze_powder>], 
